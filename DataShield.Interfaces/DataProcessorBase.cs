...
public abstract class DataProcessorBase : IDataProcessor
{
    ...
    // Отписка от входного источника (вызывать под SyncRoot)
    ...
    // Входной кусок: вычитка буфера источника и обработка под SyncRoot
    ...
    // Выброс события: делегат вычитки одноразовый (повторный вызов — пусто)
