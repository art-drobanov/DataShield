...
{
    /// <summary>ViewModel главного окна (единая на приложение).</summary>
    ...
    public MainWindow(MainViewModel vm)
    {
        ...
        Title = $"DataShield v{ver?.Major ?? 1}.{ver?.Minor ?? 0} {BuildInfo.BuildLabel}   Copyright (c) 2026 Artem Drobanov, Vladislav Utyumov";
        DataContext = _vm;
    }
