...
{
    /// <summary>Имя файла настроек в каталоге приложения.</summary>
    private const string FileName = "settings.json";

    /// <summary>Код языка интерфейса ("en" / "ru"); по умолчанию английский.</summary>
    public static string Language { get; set; } = "en";

    /// <summary>Каталог настроек в пользовательском профиле приложения.</summary>
    ...
    /// <summary>Сериализуемое представление файла настроек (JSON).</summary>
