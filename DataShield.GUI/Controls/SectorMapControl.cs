...
{
    // Кисти раскраски секторов: принят data / пропущен / принят ECC / коллизия
    ...
    // Смена любого стилизуемого свойства перерисовывает карту
    ...
    /// <summary>Запрос размера: минимальная высота 120px, ширина — по контейнеру.</summary>
    ...
    /// <summary>
    /// Отрисовка сетки секторов: подбор числа колонок под пропорции
    /// контрола, ячейки ≥ 3px рисуются с зазором, мельче — сплошными.
    /// </summary>
