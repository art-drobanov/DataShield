...
public partial class App : Application
{
    ...
    /// <summary>Загрузка XAML-разметки приложения.</summary>
    ...
    /// <summary>
    /// Инициализация после готовности фреймворка: применение сохранённого
    /// языка, создание ViewModel и главного окна, подписка на смену языка.
    /// </summary>
